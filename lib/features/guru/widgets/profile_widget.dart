      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ProfileMenuItem(
              title: 'Edit Profil',
              icon: TablerIcons.user_edit,
              onTap: onEditProfile,
            ),
            ProfileMenuItem(
              title: 'Ubah Password',
              icon: TablerIcons.lock_password,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon, size: 24, color: iconColor ?? AppColors.textGrey2),
            const SizedBox(width: 16),
            Expanded(child: Text(title, style: style ?? AppTextStyle.menuItem)),
            Icon(Icons.chevron_right, size: 20, color: AppColors.textGrey2),
          ],
        ),
      ),
    );
